...
class NewUltimateApp:
    def __init__(self, root):
        ...
        # Basic Variables - ULTIMATE ANTI-RECOIL FIX
        self.aimdown = tk.IntVar(value=18)  # MUCH STRONGER anti-recoil
        self.delay = tk.DoubleVar(value=0.005)  # EXTREMELY fast response
        self.smoothness = tk.IntVar(value=20)  # MAXIMUM smoothness
